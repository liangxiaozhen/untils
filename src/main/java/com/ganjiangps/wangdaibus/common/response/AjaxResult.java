...
public class AjaxResult {
	...
	public  AjaxResult successAjaxResult() {
		return allAjaxResult(SUCCESS_CODE, SUCCESS_MESSAGE, new Object());
	}
	...
	public  AjaxResult successAjaxResult(String message) {
		...
		return allAjaxResult(SUCCESS_CODE, message, new Object());
	}
	...
	public  AjaxResult failAjaxResult() {
		return allAjaxResult(FAIL_CODE, FAIL_MESSAGE, new Object());
	}
	...
	public  AjaxResult failAjaxResult(String message) {
		...
		return allAjaxResult(FAIL_CODE, message, new Object());
	}
	...
	public  AjaxResult logoutAjaxResult() {
		return allAjaxResult(LOGOUT_CODE, LOGOUT_MESSAGE, new Object());
	}
	...
	public  AjaxResult logoutAjaxResult(String message) {
		...
		return allAjaxResult(LOGOUT_CODE, message, new Object());
	}
