...
public class CookieUtil {
	...
	public static final String WDBCOOKIENAME = "wdbCookieName";
	public static final String WDBTOKENCOOKIENAME = "WDBTOKENCOOKIENAME";
	public static final String DECLAREQUERYMOBILECOOKIENAME = "DeclareQueryMobileCookieName";
