...
public class UserPcInterceptor implements HandlerInterceptor{
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		String requestType = request.getHeader("X-Requested-With");
 		PreCommonMember  preCommonMember = (PreCommonMember) request.getSession().getAttribute(Session_Constant.USER);
		PreUcenterMembers  preUcenterMembers = (PreUcenterMembers) request.getSession().getAttribute(Session_Constant.USERSECURITYINFO);
